...
class BasicTest(unittest.TestCase):
    def test_all_categories(self):
        # Copy from finance_app.py (hardcoded tests ok for now)
        ...
        shopping = ['Arts', 'Shopping', 'Electronics & Software', 'Music', 'Books', 'Clothing', 'Books & Supplies',
                    'Gift', 'Office Supplies', 'Mobile Phone', 'Pharmacy']
